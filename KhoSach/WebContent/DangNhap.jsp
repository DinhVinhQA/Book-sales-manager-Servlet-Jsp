							...
							<div class="popup__body">
								...
								<div class="popup__header nav nav-tabs">
									<a href="#login" role="tab" id="btn_login"
										...
										data-toggle="tab">Đăng nhập</a> <a href="#resigter" role="tab"
								...
								<div class="tab__content">
									<div class="popup__body__inner show active" role="tabpanel"
										id="login">
										<form name="popup_login_form" action="DangNhapServlet"
											...
											<div class="popup__form">
												<div class="form">
													<label style="width: 95px" for="user_loginmain_login"
														class="cm-required">Email/SĐT</label> <input
												...
												<div class="form">
													<label style="width: 95px" for="ppsw_main_login"
														class="cm-required">Mật khẩu</label> <input
											...
											<div class="popup__form">
												...
												<div class="form">
													<label for="ppassword1" class="cm-required cm-password">Mật
														...
														placeholder="Mật khẩu*" name="user_data[password1]"
														maxlength="32" autocomplete="off"
														class="cm-autocomplete-off" value="">
												</div>
												<div class="form">
													<label for="ppassword2" class="cm-required cm-password">Xác
														nhận mật khẩu</label> <input type="password" id="ppassword2"
														placeholder="Mật khẩu*" name="user_data[password2]"
														maxlength="32" autocomplete="off"
														class="cm-autocomplete-off" value="">
												</div>
												<div class="form">
													...
													<div class="popup__checkbox popup__checkbox--inline">
														<input type="radio" name="user_data[render]" value="male"
															id="male"> <label for="male">Nam</label> <input
															type="radio" name="user_data[render]" value="female"
															id="female" checked=""> <label for="female">Nữ</label>
													</div>
												</div>
												<div class="form">
												...
												<div class="button-left">
													...
													<div class="popup__register">
														...
														<button class="button btn-orrange"
															name="dispatch[profiles.update]" type="submit">Đăng
															Ký</button>
													</div>
												</div>
											</div>
