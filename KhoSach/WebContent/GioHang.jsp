...
<section class="product-detail bg-gray py-5" style="padding-top: 0px !important">
	<div class="container">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb text-capitalize bg-white">
				<li class="breadcrumb-item"><a href="GioHangServlet"
					class="text-purple font-15pt">trang chủ</a></li>
				<li class="breadcrumb-item active font-15pt">giỏ hàng</li>
			</ol>
		</nav>
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<div class="cart-empty text-center">
					...
					<a style="background: #ff5800;" href="DeMoSach"
				...
				<div class="table-scroll position-relative"
					...
					<table
						...
						<tbody class="font-15pt">
							<%
							    for(GioHangBEAN gh : gio){ TongTien =TongTien + (gh.getGia()*gh.getSoLuong());
							%>
							<tr>
								...
								<td style="text-align: center">
									<div style="display: inline-flex;" class="cart-plus-minus">
										<a
											href="CapNhatSoLuongGioHangServlet?mS=<%=gh.getMaSach()%>&sL=<%=(int)-1%>"
											...
											id="quantity_<%=gh.getSoLuong()%>"
											name="quantity_<%=gh.getSoLuong()%>"
											value="<%=gh.getSoLuong()%>" inputmode="numberic"> <a
											href="CapNhatSoLuongGioHangServlet?mS=<%=gh.getMaSach()%>&sL=<%=(int)+1%>"
											class="dec qtybutton btn"
											style="margin-left: 3px; background: #ff5800;">+</a>
									</div>
								</td>
								<td style="text-align: center" class="nowrap-text"><%=gh.getGia()%>đ</td>
								<td style="text-align: center" class="nowrap-text"><%=gh.getSoLuong()*gh.getGia()%>đ</td>
								<td style="text-align: center" class="text-danger font-title">
									<div class="del-product">
										<a href="XoaSachTrongGioServlet?mS=<%=gh.getMaSach()%>"
