...
.cart-cofirm-container .cart-confirm-item:last-child {
	border-bottom: none;
}
...
.cart-confirm-img, .cart-confirm-quantity {
	width: 20%;
}

.cart-confirm-title, .cart-confirm-price {
	width: 30%;
}
</style>
</head>
			...
			<div class="container">
				<div class="header__left-right">
					...
					<div class="header__wrapper-right">
						...
						</a> <a href="GioHangServlet"
							class="header__wrapper-link shopping__cart-icon"> <i
							class="fas fa-shopping-cart"></i> <span class="number__cart">
								<%
									int soLuongSP=0;
				...
				<div class="header__menu">
					<nav>
						<ul class="header__menu-list">
							<li class="header__menu-item"><a href="DeMoSach.jsp"
							...
							<li class="header__menu-item"><a href=""
								...
								<ul class="header__menu-list-sub">
									<li><a href="" class="header__menu-link-sub">Thông tin
											cá nhân</a></li>
