		...
		<li class="nav-item dropdown no-arrow">
			<div style="display: inline-flex;">
				<h5 style="padding-top: 5px; padding-right: 30px; color: #000;">
					Xin chào admin <i class="fas fa-user-circle fa-fw"></i>
				</h5>
				<div>
	...
	<ul class="sidebar navbar-nav">
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown">
				...
				<a class="dropdown-item" href="index.php">Danh sách khách hàng</a>
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown">
				...
				<a class="dropdown-item" href="addpost.php">Số lượn sản phẩm bán</a>
