        ...
        try {
            ...
            if (request.getParameter("userName") != null) {
                ...
                if (khBO.kiemTraDangNhap(userName, password) == true) {
                    session.setAttribute("maKhachHang",
                            khBO.getMaKhachHang(userName));
                    ...
                    session.setAttribute("gio",
                            ghBO.getGioHangs(khBO.getMaKhachHang(userName)));
                    session.setAttribute("KhachHang",
                            khBO.getKhachHang(khBO.getMaKhachHang(userName)));
                    response.sendRedirect("GioHangServlet");
                } else {
                    RequestDispatcher rd = request
                            .getRequestDispatcher("DeMoSach.jsp");
